  ...
  <x-admin-dashboard>
    ...
    <form method="POST" action="/projects" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" name="title_fa" value="{{ old('title_fa') }}" class="form-control" id="floatingInput">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" name="summary_fa" value="{{ old('summary_fa') }}" class="form-control" id="floatingInput">
              ...
              <div class="carousel-item bg-transparent" id="english-page">
                <div class="container bg-transparent">
                  <!-- Page 2 content here (English Input) -->
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" name="title_en" value="{{ old('title_en') }}" class="form-control" id="floatingInput">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" name="summary_en" value="{{ old('summary_en') }}" class="form-control" id="floatingInput">
