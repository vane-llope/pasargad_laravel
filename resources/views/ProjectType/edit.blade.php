  ...
  <div class="card">
    ...
    <form method="POST" action="/projectTypes/{{$projectType->id}}" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3">
          <input type="text" name="name_fa" value="{{$projectType->name_fa}}"  class="form-control" id="floatingInput" >
        ...
        <div class="form-floating mb-3">
          <input type="text" name="name_en" value="{{$projectType->name_en}}"  class="form-control" id="floatingInput" >
