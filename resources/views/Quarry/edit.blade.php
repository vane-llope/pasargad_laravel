        ...
        <div class="card-body">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active bg-transparent" id="farsi-page">
                <div class="container bg-transparent">
                  ...
                  <form method="POST" action="/quarries/{{ $quarry->id }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    
                    <div class="form-floating mb-3">
                      <input type="text" name="name_fa" value="{{ $quarry->name_fa }}" class="form-control" id="floatingInput" >
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" name="address_fa" value="{{ $quarry->address_fa }}" class="form-control" id="floatingInput" >
              ...
              <div class="carousel-item bg-transparent" id="english-page">
                <div class="container bg-transparent">
                  <!-- Page 2 content here (English Input) -->
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" name="name_en" value="{{ $quarry->name_en }}" class="form-control" id="floatingInput" >
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" name="address_en" value="{{ $quarry->address_en }}" class="form-control" id="floatingInput" >
          ...
          <div class="container">
            <select name="stone_type_id" class="form-select mb-3" aria-label="Default select example">
              ...
              <option value="{{ $stoneType->id }}" @if($stoneType->id == $quarry->stone_type_id) selected @endif>{{ $stoneType['name_'. app()->getLocale()] }}</option>
              @endforeach
            </select>
            @error('stone_type_id')
            <p class="text-danger">{{ $message }}</p>
            ...
            <x-multiple-image-uploader :images="$quarry->images" />
          </div>
